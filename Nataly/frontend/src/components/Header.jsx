  ...
  return (
    <header className="py-10 bg-indigo-600">
        ...
        <nav className="flex flex-col items-center lg:flex-row gap-4 mt-5 lg:mt-0">
            <Link to ="/admin" className="text-white text-sm uppercase font-bold px-4 ">Pacientes</Link>
            <Link to ="/pefil" className="text-white text-sm uppercase font-bold px-4">Perfil</Link>
